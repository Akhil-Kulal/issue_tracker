...
// importing collection from mongodb of which schema is already set
...
app.post("/project-detail", function (req, res) {
  ...
  Project.findById(id, function (err, project) {
    ...
    if (req.body.title && req.body.filterByAuthor && req.body.filterByLabel) {
      Issue.find(
        {
          $and: [
            ...
            { author: req.body.filterByAuthor },
            { label: req.body.filterByLabel },
          ],
        },
        function (err, issues) {
          return res.render("project_detail", {
      ...
      req.body.title ||
      req.body.filterByAuthor ||
      req.body.filterByLabel
    ) {
      Issue.find(
        {
          $and: [
